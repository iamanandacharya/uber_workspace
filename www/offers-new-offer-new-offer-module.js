...
var NewOfferPage = /** @class */ (function () {
    ...
    NewOfferPage.prototype.onLocationSet = function (location) {
        this.form.patchValue({ location: location });
    };
    NewOfferPage.prototype.onCreateOffer = function () {
        ...
        this.loadingCtrl
            ...
            loadingEl.present();
            _this.placesService
                .addPlace(_this.form.value.title, _this.form.value.description, +_this.form.value.price, new Date(_this.form.value.dateFrom), new Date(_this.form.value.dateTo), _this.form.value.location)
                .subscribe(function () {
                loadingEl.dismiss();
                _this.form.reset();
