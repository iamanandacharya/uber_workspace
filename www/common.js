...
var BookingService = /** @class */ (function () {
    ...
    BookingService.prototype.addBooking = function (placeId, placeTitle, placeImage, firstName, lastName, guestNumber, dateFrom, dateTo) {
        var _this = this;
        var generatedId;
        var newBooking = new _booking_model__WEBPACK_IMPORTED_MODULE_4__["Booking"](Math.random().toString(), placeId, this.authService.userId, placeTitle, placeImage, firstName, lastName, guestNumber, dateFrom, dateTo);
        return this.http
            .post('https://ionic-angular-course.firebaseio.com/bookings.json', __assign({}, newBooking, { id: null }))
    ...
    BookingService.prototype.cancelBooking = function (bookingId) {
        var _this = this;
        return this.http
            .delete("https://ionic-angular-course.firebaseio.com/bookings/" + bookingId + ".json")
    ...
    BookingService.prototype.fetchBookings = function () {
        var _this = this;
        return this.http
            .get("https://ionic-angular-course.firebaseio.com/bookings.json?orderBy=\"userId\"&equalTo=\"" + this.authService.userId + "\"")
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (bookingData) {
            var bookings = [];
...
var PlacesService = /** @class */ (function () {
    ...
    PlacesService.prototype.fetchPlaces = function () {
        var _this = this;
        return this.http
            .get('https://ionic-angular-course.firebaseio.com/offered-places.json')
    ...
    PlacesService.prototype.getPlace = function (id) {
        return this.http
            .get("https://ionic-angular-course.firebaseio.com/offered-places/" + id + ".json")
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (placeData) {
    ...
    PlacesService.prototype.addPlace = function (title, description, price, dateFrom, dateTo, location) {
        var _this = this;
        var generatedId;
        var newPlace = new _place_model__WEBPACK_IMPORTED_MODULE_4__["Place"](Math.random().toString(), title, description, 'https://lonelyplanetimages.imgix.net/mastheads/GettyImages-538096543_medium.jpg?sharp=10&vib=20&w=1200', price, dateFrom, dateTo, this.authService.userId, location);
        return this.http
            .post('https://ionic-angular-course.firebaseio.com/offered-places.json', __assign({}, newPlace, { id: null }))
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["switchMap"])(function (resData) {
            generatedId = resData.name;
            return _this.places;
    ...
    PlacesService.prototype.updatePlace = function (placeId, title, description) {
        var _this = this;
        var updatedPlaces;
        return this.places.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["take"])(1), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["switchMap"])(function (places) {
            ...
            return _this.http.put("https://ionic-angular-course.firebaseio.com/offered-places/" + placeId + ".json", __assign({}, updatedPlaces[updatedPlaceIndex], { id: null }));
